      ...
      <div className="mx-auto max-w-7xl">
        ...
        {analytics && (
          <motion.section
            ...
            <h2 className="text-xl font-semibold font-serif mb-4">Overview</h2>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-3xl font-bold">{analytics.totalModerators}</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
                ...
                <CardContent>
                  <p className="text-3xl font-bold">{analytics.totalAdmins}</p>
                </CardContent>
              </Card>
            </div>
          </motion.section>
