            ...
            <div className="grid grid-cols-1 gap-6">
                {interactions.length === 0 ? (
                    ...
                    interactions.map((interaction) => {
                        ...
                        return (
                            <Card key={interaction.id} className={`overflow-hidden transition-all duration-300 border-2 ${isCurrent ? 'ring-4 ring-primary/10 border-primary shadow-xl scale-[1.01]' : 'hover:border-muted-foreground/30 shadow-sm'}`}>
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <div className="space-y-4">
                                        {displayTranscript && (
                                            <div className="p-1 rounded-2xl bg-gradient-to-r from-primary/5 via-background to-primary/5 border shadow-sm">
